...
export const projects: Project[] = [
{
  ...
  },
  {
    ...
    {
    id: "iceberg",
    title: "UI/UX Motion Graphics Iceberg",
    ...
    fullDescription: "A bento style showcase of interactable UI elements with a focus on motion graphics and user experience. I started this project out of pure curiosity as to how super stylized animated buttons and visuals were created in the handful of medias I've seen. What are the best practices? What tools should be used? How can motion graphics be integrated?",
    challenges: "",
    outcome: "",
    imageUrl: "chicago.png",
    imageUrl2: "chicago.png",
    ...
    tools: ["Figma", "React", "GSAP", "Three.js", "p5.js", "Rive", "Photoshop", "Illustrator", "After Effect"],
    problem: "",
    subProblem: "",
    solution: "",
    status: "Currently in development... Stay tuned for updates!",

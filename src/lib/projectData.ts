...
export const projects: Project[] = [
{
  ...
  },
  {
    ...
    solution: "Wanting an explorative way to showcase a personal design class project digitally, I developed FolioFolds, a web application that allows users to create and share interactive 3D models of printworks. The platform features an intuitive drag-and-drop interface for designing complex folds and bindings, along with real-time 3D rendering powered by WebGL. Users can easily visualize their designs from multiple angles and even embedd them into their own website and view them in AR using their mobile devices. Publications can be flipped through manually or viewed through animation, fostering a vibrant ecosystem of print design enthusiasts.",
    keyProblems:[

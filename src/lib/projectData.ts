...
export const projects: Project[] = [
  {
    ...
    fullDescription: "WorldNotes is a personal passion project created to be a global platform for sharing notes, thoughts, and doodles, perfect for casual web strolling. The platform emphasizes user agency, discovery, and building community through creative expression.",

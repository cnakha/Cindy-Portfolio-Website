            ...
            <div className="mt-10 mb-10  flex flex-row items-center justify-center min-h-[60vh] p-8 gap-8 flex-wrap md:flex-row sm:flex-col sm:p-4 sm:gap-4">
                <div className="flex-1 min-w-[250px]">
                    ...
                    <p className="text-2xl text-white">
                        Hi there! I'm Cindy Nakhammouane, a fullstack developer and UI/UX designer currently enrolled in my fourth year at the University of Illinois Chicago to study Computer Science and Design. <br/> <br/>
                        ...
                        I'm currently exploring career paths in the fields of AI/ML, web dev, project management, and UI/UX design, so . <br/> <br/>
